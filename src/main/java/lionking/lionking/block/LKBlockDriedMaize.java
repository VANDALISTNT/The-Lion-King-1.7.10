...
public class LKBlockDriedMaize extends Block {
    @SideOnly(Side.CLIENT)
    private IIcon cornIcon;

    public LKBlockDriedMaize() { 
    ...
    public void registerBlockIcons(IIconRegister iconRegister) { 
        this.blockIcon = iconRegister.registerIcon("lionking:driedMaize");
        cornIcon = iconRegister.registerIcon("lionking:driedMaize_corn");
    }
